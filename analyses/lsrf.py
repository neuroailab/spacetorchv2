...
def main():
    ...
    responses = get_expanding_sine_responses(
        model,
        layers=[args.layer],
        normalize_to_ringach_firing_rates=("tdann" in cfg.name),
    ...
    np.save(save_dir / "lsrf_curves.npy", curves)
    ...
    plt.savefig(save_dir / "lsrf_curves.png", dpi=300, bbox_inches='tight')
