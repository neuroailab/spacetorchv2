...
if __name__ == "__main__":
    ...
    python -m torch.distributed.launch --nproc_per_node=8 spacetorch/run/train.py --config spacetorch/configs/vitb14_dinov2_imagenet/swapopt_lwx1.yaml output_dir=checkpoints/vitb14_dinov2_imagenet_swapopt_lwx1 wandb=True
    """
