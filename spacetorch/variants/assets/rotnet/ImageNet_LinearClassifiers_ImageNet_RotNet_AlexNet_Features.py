...
pretrained = ''
networks['feat_extractor'] = {'def_file': 'spacetorch/variants/assets/rotnet/architectures/AlexNet.py', 'pretrained': pretrained, 'opt': {'num_classes': 4},  'optim_params': None} 
...
networks['classifier']  = {'def_file': 'spacetorch/variants/assets/rotnet/architectures/MultipleLinearClassifiers.py', 'pretrained': None, 'opt': net_opt_cls, 'optim_params': net_optim_params_cls}
