...
networks['model'] = {'def_file': 'spacetorch/variants/assets/rotnet/architectures/AlexNet.py', 'pretrained': None, 'opt': net_opt,  'optim_params': net_optim_params} 
config['networks'] = networks

criterions = {}
criterions['loss'] = {'ctype':'NTXentLoss', 'opt':None}
