...
from spacetorch.variants.assets.swin_moby.utils import load_checkpoint, save_checkpoint, get_grad_norm, auto_resume_helper
...
def main_loop(config, model_wrapper, args, positions, layernames, logger):
    ...
    model = model_wrapper(build_model(config), args, positions, layernames)
    model.cuda()
    ...
    for epoch in range(config.TRAIN.START_EPOCH, config.TRAIN.EPOCHS):
        ...
        train_one_epoch(config, model, data_loader_train, optimizer, epoch, lr_scheduler, logger)
