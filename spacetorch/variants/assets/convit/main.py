...
from spacetorch.variants.assets.convit.datasets import build_dataset
from spacetorch.variants.assets.convit.engine import train_one_epoch, evaluate
from spacetorch.variants.assets.convit.samplers import RASampler
import spacetorch.variants.assets.convit.models as models
import spacetorch.variants.assets.convit.utils as utils
...
def main(args, model_wrapper, spatial_args, positions, layernames):
    ...
    model = model_wrapper(base_model, spatial_args, positions, layernames)
