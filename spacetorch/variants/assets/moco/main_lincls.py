...
import spacetorch.variants.assets.moco.vits as vits
...
def validate(val_loader, model, criterion, args):
    ...
    with torch.no_grad():
        ...
        if not args.multiprocessing_distributed or (args.multiprocessing_distributed
            and args.rank == 0):
            with open(args.save_dir / "linear_classification.txt", "a") as f:
                f.write('Acc@1 {top1.avg:.7f} Acc@5 {top5.avg:.7f}\n'
                 .format(top1=top1, top5=top5))
...
def sanity_check(state_dict, pretrained_weights, linear_keyword):
    ...
    for k in list(state_dict.keys()):
        ...
        k_pre = 'module.model.base_encoder.' + k[len('module.'):] \
            if k.startswith('module.') else 'module.model.base_encoder.' + k
