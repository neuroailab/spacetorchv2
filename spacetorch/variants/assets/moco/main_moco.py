...
import spacetorch.variants.assets.moco.optimizer as optimizer
...
def train(train_loader, model, optimizer, scaler, summary_writer, epoch, args):
    ...
    for i, (images, _) in enumerate(train_loader):
        ...
        with torch.cuda.amp.autocast(True):
            loss, spatial_outputs = model(images[0], images[1], moco_m)
        ...
        optimizer.zero_grad()
        joint_loss = model.module.get_joint_loss((loss, spatial_outputs))
