...
from spacetorch.variants.assets.moco.optimizer import LARS
...
class ResNet50_MoCov3(BaseArch):
    """
    ...
    def _load_pretrained_weights(self, args, model):
        ...
        for k in list(state_dict.keys()):
            ...
            if k.startswith('module.model.base_encoder') and not k.startswith('module.model.base_encoder.%s' % "fc"):
                # remove prefix
...
def main_worker(gpu, ngpus_per_node, args, positions, layernames):
    ...
    if args.optimizer == 'lars':
        optimizer = LARS(model.parameters(), args.lr,
